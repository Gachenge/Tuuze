                        ...
                        @auth
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    <ul class="list-group">
                                        @foreach ($myNotifications as $nots)
                                            <a href="{{ route('notifications.show', $nots->id) }}" class="nav-link">
                                                <li class="list-group-item">{{ $nots->subject }}</li>
                                            </a>
                                        @endforeach
                                        <a href="{{ route('notifications.index') }}" class="nav-link">
                                            <li class="list-group-item list-group-item-success">View all</li>
                                        </a>
                                    </ul>
                                </div>
                            </li>
            ...
            <div class="row">
                ...
                <div class="page-left-section rounded-20 px-md-4 py-4">
                    <div class="sidebar-nav sidebar scrollbar">
                        <nav class="side-menu-nav border rounded-20 scrollbar">
                            <ul class="nav">
                                <li class="nav-item">
                                    <a class="nav-link active" href="{{ route('home.dashboard') }}">🏠 Dashboard</a>
                                </li>
                                <li class="nav-item">
                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4 page-right-section">
                    ...
                    @if (session('impersonator_id'))
                        <div class="bg-yellow-200 text-black p-3 text-center">
                            ⚠️ You are impersonating <strong>{{ auth()->user()->name }}</strong>.
                            <a href="{{ route('admin.stopImpersonate') }}" class="ml-3 text-blue-600 underline">
