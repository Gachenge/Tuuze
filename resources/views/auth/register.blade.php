...
<div class="container">
    <div class="d-flex flex-column justify-content-center">
        <div class="row d-flex flex-column justify-content-center flex-column">
            ...
            <h1 class="fw-bold primary-text ms-5">Hi, welcome</h1>
            <p class="text-center fw-semibold">Please fill in your details to register</p>
            </div>
        </div>
        ...
        <div class="row mb-0">
         ...
         <p class="mt-3 text-center">
            Already have an account ? <span class="primary-text fw-bold">
                <a class="text-decoration-none" href="{{ route('login') }}"><span class="primary-text fw-bold">Log in</span></a>
            </span>
            <br><br>
