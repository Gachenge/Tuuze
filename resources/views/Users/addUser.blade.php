        ...
        <div class="row">
            <div class="col-8">
                <div class="card card-shadow feedback">
                    <div class="card-top">
                        <h2 class="primary-text ms-5 mt-2">Add users</h2>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('users.storeUser', $id) }}" class="form-group m-5 mt-2">
                            {{ csrf_field() }}
                            {{ method_field('POST') }}
                            ...
                            <div class="mb-3 {{ $errors->has('email') ? ' has-error' : '' }}">
                                ...
                                {!! Form::select('role_id', getBusinessRoles($id), null, ['class' => 'form-control']) !!}
                                @if ($errors->has('role'))
                                    <span class="help-block">
