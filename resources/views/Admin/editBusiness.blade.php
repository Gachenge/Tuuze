        ...
        <div class="row">
            <div class="col-8">
                <div class="card card-shadow feedback">
                    <div class="card-top">
                        <h2 class="primary-text ms-5 mt-2">Edit business</h2>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.updateBusiness', ['id' => $business->id]) }}"
                            ...
                            <div class="mb-3 {{ $errors->has('initials') ? ' has-error' : '' }}">
                                ...
                                <input id="initials" name="initials" type="text" class="form-control"
                                    value="{{ old('initials', $business->initials) }}" required autofocus>
                            ...
                            <div class="mb-3 {{ $errors->has('email') ? ' has-error' : '' }}">
                                ...
                                <input id="email" name="email" type="email" class="form-control"
                                    value="{{ old('email', $business->email) }}" required autofocus>
                                @if ($errors->has('email'))
                                    <span class="help-block">
                            ...
                            <div class="mb-3 {{ $errors->has('domain') ? ' has-error' : '' }}">
                                ...
                                <input id="domain" type="text" class="form-control" name="domain"
                                    value="{{ old('domain', $business->domain) }}" required>
                            ...
                            <div class="mb-3 {{ $errors->has('logo_file') ? ' has-error' : '' }}">
                                ...
                                @if ($business->logo)
                                    <div class="mb-2">
                                        <img src="{{ asset('storage/logos/' . $business->logo) }}" alt="Logo"
